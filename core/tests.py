...
class TestSurveyMini(APITestCase):
    client = APIClient()
...
class TestOptionMini(APITestCase):
    client = APIClient()
    ...
    urls = {
        'create': '/api/options/',
        'update': '/api/options/1/1',
        'delete': '/api/options/1/1',
    }
...
class TestVoteMini(APITestCase):
    client = APIClient()
    createoption = {
        'option': 'test_option',
        'survey': 1,
...
class TestSurvey(APITestCase):
    ...
    urls = {
        'create': '/api/surveys/',
        'update': '/api/surveys/survey=1',
        'delete': '/api/surveys/survey=1',
    }
